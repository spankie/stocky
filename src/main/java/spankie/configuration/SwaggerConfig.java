  ...
  private ApiInfo metadata() {
    return new ApiInfoBuilder()//
        ...
        .description(
            ...
            "For this sample, you can use the `admin` or `client` users (password: admin "+
            "and client respectively) to test the authorization filters. "+
            "Once you have successfully logged in and obtained the token, "+
            "you should click on the right top button `Authorize` and introduce "+
            "it with the prefix \"Bearer \".")//
        .version("1.0.0")//
